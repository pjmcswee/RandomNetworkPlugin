...
//import org.cytoscape.randomnetwork.gui.*;
//import org.cytoscape.plugin.*;
//import org.cytoscape.*;
//import org.cytoscape.util.*;
//import javax.swing.*;
...
public class RandomNetworkPlugin extends CytoscapePlugin implements PropertyChangeListener {
    ...
    public RandomNetworkPlugin() {
        ...
        isnAction = new InduceRandomAction();
        crAction = new CompareRandomAction();
        grAction.setPreferredMenu("Plugins.Random Networks");
        isnAction.setPreferredMenu("Plugins.Random Networks");
        ...
        Cytoscape.getDesktop().getCyMenus().addAction(isnAction);
     ...
     *
    class RandomNetworkFrame extends JDialog {
     ...
     *  The action which brings up our dialog
     *
    class InduceRandomAction extends CytoscapeAction {

        /**
         * Default constructor
         *
        public InduceRandomAction() {
            super("Induce a Random Sub-Network");
        }
        ...
        public void actionPerformed(ActionEvent ae) {
            RandomNetworkFrame frame = new RandomNetworkFrame();
            frame.start(new RandomWalkInducerPanel(0));
        }
    }
    */
//}
