...
public class ErdosRenyiModel extends RandomNetworkModel {
    ...
    public RandomNetworkImpl generate() {
        ...
        RandomNetworkImpl random_network = null;
        if (probability == UNSPECIFIED) {
     ...
     */
    private RandomNetworkImpl gnmModel() {
        ...
        List<Integer> existingEdges = new ArrayList<Integer>();
        ...
        for (int i = 0; i < numEdges; i++) {
            ...
            //Create the edge
            random_network.createEdge(nodes[source], nodes[target], directed);
     ...
     */
    public RandomNetworkImpl gnpModel() {
        //Create a network
        RandomNetworkImpl random_network = new RandomNetworkImpl(directed);
        random_network.setNetworkName(getName());
