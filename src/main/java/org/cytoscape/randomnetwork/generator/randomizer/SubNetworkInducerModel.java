 ...
 * @version 1.0
 */
public abstract class SubNetworkInducerModel extends NetworkRandomizerModel {
     ...
     */
    SubNetworkInducerModel(RandomNetwork pRandomNetwork, boolean pDirected) {
        super(pRandomNetwork, pDirected);
    }
}
