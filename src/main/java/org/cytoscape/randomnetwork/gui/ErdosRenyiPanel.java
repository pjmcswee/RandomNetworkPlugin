...
public class ErdosRenyiPanel extends RandomNetworkPanel implements ActionListener {
    ...
    private void initComponents() {
        ...
        setMinimumSize(nodeTextField);
        setMinimumSize(edgeTextField);
        setMinimumSize(probabilityTextField);
        ...
        hLine.setPreferredSize(new Dimension(5,5));
        hLine.setMinimumSize(new Dimension(5,5));
        
        line = new JSeparator(SwingConstants.VERTICAL);

        //Set the text for the labels
        directedCheckBox.setText("Undirected");
        selfEdgeCheckBox.setText("Reflexive Edges (u,u)?");
        gnp.setText("G(n,p)");
        gnm.setText("G(n,m)");
    ...
    public RandomNetworkPanel next() {
        ...
        RandomNetworkImpl graph = erm.generate();
