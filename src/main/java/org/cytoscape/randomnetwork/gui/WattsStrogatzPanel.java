...
import org.cytoscape.randomnetwork.generators.WattsStrogatzModel;
...
public class WattsStrogatzPanel extends RandomNetworkPanel {
    ...
    private void initComponents() {
        ...
        betaTextField.setMinimumSize(new Dimension(50, 25));
        degreeTextField.setMinimumSize(new Dimension(50, 25));
    ...
    public RandomNetworkPanel next() {
        ...
        RandomNetworkImpl network = wsm.generate();
